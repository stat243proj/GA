...
ExtractResponseVariable <- function(dataset, name){
  ...
  #Takes a dataframe and the name of a variable as a character string. Splits the dataframe into predictors and
  #response and returns these as elements of a list
